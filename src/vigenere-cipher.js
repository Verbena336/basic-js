...
class VigenereCipheringMachine {
  ...
  decrypt(message, key) {
    ...
    for(let i = 0; i < mesArr.length; i++) {
      ...
      let j = matrix[alphabete.indexOf(keyArr[keyIndex])].indexOf(mesArr[i]) ///сначала ищем в алфавите индекс нужной буквы ключа
      res.push(alphabete[j])                                                 ///по нему в матрице находим строку
      keyIndex += 1                                                          ///в ней ищем индекс нужной буквы в сообщении
